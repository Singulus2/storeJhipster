...
import com.devk.store.domain.Notification;
import com.devk.store.repository.NotificationRepository;
...
/**
 * REST controller for managing {@link com.devk.store.domain.Notification}.
 */
@RestController
@RequestMapping("/api")
@Transactional
