...
import com.devk.store.repository.ProductOrderRepository;
import com.devk.store.service.ProductOrderService;
...
/**
 * REST controller for managing {@link com.devk.store.domain.ProductOrder}.
 */
@RestController
@RequestMapping("/api")
