...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.devk.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.devk.store.security.DomainUserDetailsService", "createSpringSecurityUser");
