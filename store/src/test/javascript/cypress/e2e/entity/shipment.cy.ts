...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2023-04-13T17:10:44.261Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'robust scale',
        date: '2023-04-14T09:50:45.314Z',
        details: 'withdrawal sensor',
        status: 'PAID',
        paymentMethod: 'CREDIT_CARD',
        paymentDate: '2023-04-13T15:34:45.996Z',
        paymentAmount: 16937,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-04-13T18:36').blur().should('have.value', '2023-04-13T18:36');
