...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    code: 'Berkshire Self-enabling',
    date: '2023-04-14T09:15:57.347Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2023-04-14T12:29:42.969Z',
    paymentAmount: 88901,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-04-14T10:23').blur().should('have.value', '2023-04-14T10:23');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2023-04-14T02:32').blur().should('have.value', '2023-04-14T02:32');
